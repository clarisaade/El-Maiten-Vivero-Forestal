...
<nav class="nav">
            ...
            <div class="menu">
                ...
                <li class="menu-item"><a href="index.html#servicios" tittle="ancla servicios">SERVICIOS</a></li>
                    ...
                    <li class="animate__animated animate__tada animate__delay-1s animate__repeat-2	2">
                        <a id="app-whatsapp" target="_blanck" href="https://api.whatsapp.com/send?phone=+5492916499028&text=HOla">
                            <img class="whatsapp-img" , src="img/whatsapp.png" alt="whatsapp">
                        </a>
                    </li>
                </ul>
            </div>
